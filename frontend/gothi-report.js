class GothiReport extends HTMLElement {
	...
	connectedCallback() {
		...
		let spell = {
			"Alyrja": "<tooltip-element tooltip=\"Once summoned, the Warwind makes every sea region treacherous and pushes all occupants of each sea region to a random adjacent region each week. Like all spells, it has a 66% chance of continuing each week after the gothi cease summoning it, and will start to destroy crops after a couple weeks.\">Warwind</tooltip-element>",
			"Rjinku": "<tooltip-element tooltip=\"Once summoned, the Quake has a one-third chance to destroy each construction each week. Like all spells, it has a 66% chance of continuing each week after the gothi cease summoning it, and will start to destroy crops after a couple weeks.\">Quake</tooltip-element>",
			"Lyskr": "<tooltip-element tooltip=\"Once summoned, the Veil hides all navies, armies, and characters from other rulers, but does not otherwise obstruct their activities or prevent battles. Like all spells, it has a 66% chance of continuing each week after the gothi cease summoning it, and will start to destroy crops after a couple weeks.\">Veil</tooltip-element>",
			"Syrjen": "<tooltip-element tooltip=\"Once summoned, the Deluge makes every land region treacherous and allows navies to move between land regions, participate in battles in land regions, and prevents them from being captured. Like all spells, it has a 66% chance of continuing each week after the gothi cease summoning it, and will start to destroy crops after a couple weeks.\">Deluge</tooltip-element>",
		};
