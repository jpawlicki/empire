...
class Noble {
	 ...
	 * @return a notification that should be added to the world.
	 */
	Optional<Notification> createCrisis(World w, Region r, Map<Army, Character> leaders, Map<Region, ArrayList<Character>> governors, Set<Region> builds, Set<Region> templeBuilds, Map<String, Double> rationing, Set<String> lastStands, int inspires) {
		...
		for (Crisis.Type type : Crisis.Type.values()) {
			if (type.checkCreateable(w, r, leaders, governors, builds, templeBuilds, rationing, lastStands, inspires)) possibleCrises.add(type);
		}
...
final class Crisis {
	...
	static enum Type {
		NONE("", "", "") {
			@Override
			boolean checkSolved(World w, Region r, Map<Army, Character> leaders, Map<Region, ArrayList<Character>> governors, Set<Region> builds, Set<Region> templeBuilds, Map<String, Double> rationing, Set<String> lastStands, int inspires) {
				return false;
			}

			@Override
			boolean checkCreateable(World w, Region r, Map<Army, Character> leaders, Map<Region, ArrayList<Character>> governors, Set<Region> builds, Set<Region> templeBuilds, Map<String, Double> rationing, Set<String> lastStands, int inspires) {
				return false;
			}
		},
		...
		abstract boolean checkSolved(World w, Region r, Map<Army, Character> leaders, Map<Region, ArrayList<Character>> governors, Set<Region> builds, Set<Region> templeBuilds, Map<String, Double> rationing, Set<String> lastStands, int inspires);
		abstract boolean checkCreateable(World w, Region r, Map<Army, Character> leaders, Map<Region, ArrayList<Character>> governors, Set<Region> builds, Set<Region> templeBuilds, Map<String, Double> rationing, Set<String> lastStands, int inspires);
		...
		private Type(String startMessage, String successMessage, String failMessage) {
