...
public class Church {
	public enum Doctrine {
		ANTIAPOSTASY("antiapostasy. Any rulers who have sworn loyalty to the Cult are named apostates and enemies of the Church of Iruhan!", "antiapostacy. The Church follows Iruhan's example of forgiveness by forgiving the sin of aligning with the Cult."),
		...
		ANTISCHISMATICISM("antischismaticism. The Church declares the Vessel of Faith interpretation of Iruhan's words heretical, and condemns the construction of temples with that emphasis!", "antischismaticism. The Church accepts the right for people to study Iruhan's teachings without its direct guidance."),
